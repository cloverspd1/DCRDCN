namespace BEL.DCRDCNWorkflow.Models
{
    ...
    public class DCNAdminForm : IForm
    {
        /// <summary>
        ...
        {
            get { return FormNames.DCNADMINFORM; }
        }
