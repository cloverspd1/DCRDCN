namespace BEL.DCRDCNWorkflow.Models.DCN
{
    ...
    public class VendorDCRSection : ISection
    {
        ...
        public VendorDCRSection(bool isSet)
        {
            if (isSet)
            {
        ...
        /// The Vendor DCR
        /// </value>
        [DataMember, IsListColumn(false), IsTran(true, DCRDCNListNames.VENDORDCRLIST, typeof(Vendor))]
