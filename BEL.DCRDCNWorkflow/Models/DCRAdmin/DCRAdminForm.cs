namespace BEL.DCRDCNWorkflow.Models
{
    ...
    public class DCRAdminForm : IForm
    {
        /// <summary>
        ...
        {
            get { return FormNames.DCRADMINFORM; }
        }
