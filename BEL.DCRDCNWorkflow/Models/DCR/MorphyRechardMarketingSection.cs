namespace BEL.DCRDCNWorkflow.Models.DCR
{
    ...
    public class MorphyRechardMarketingSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketingSection"/> class.
        /// </summary>
        public MorphyRechardMarketingSection()
        {
        }
        ...
        public MorphyRechardMarketingSection(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(DCRDCNListNames.DCRLIST, true) };
                this.SectionName = DCRSectionName.MORPHYRECHARDMARKETINGSECTION;
