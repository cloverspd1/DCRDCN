namespace BEL.DCRDCNWorkflow.Models.DCR
{
    ...
    public class LightingMarketingSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LightingMarketingSection"/> class.
        /// </summary>
        public LightingMarketingSection()
        {
        }
        ...
        public LightingMarketingSection(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(DCRDCNListNames.DCRLIST, true) };
                this.SectionName = DCRSectionName.LIGHTINGMARKETINGSECTION;
