namespace BEL.DCRDCNWorkflow.Models.DCR
{
    ...
    public class MarketingInchargeSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketingInchargeSection"/> class.
        /// </summary>
        public MarketingInchargeSection()
        {
        }
        ...
        public MarketingInchargeSection(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(DCRDCNListNames.DCRLIST, true) };
                this.SectionName = DCRSectionName.MARKETINGINCHARGESECTION;
        ...
        /// </value>
        [DataMember, Required, FieldColumnName("MarketingDCRToBeConsidered")]
        public string MarketingDCRTOBECONSIDERED { get; set; }
        ...
        public string MarketingExpectedEffectOfChange { get; set; }
        ...
        /// </value>
        [DataMember, Required]
        public bool MarketingDCRToBeConsidered { get; set; }
