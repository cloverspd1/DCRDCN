namespace BEL.DCRDCNWorkflow.Models.DCR
{
    ...
    public class VendorDCR : ITrans
    {
        ...
        /// The Vendor Name.
        /// </value>
        [DataMember, FieldColumnName("Title"), Required, MaxLength(255, ErrorMessage = "Max Allow 255 character.")]
        ...
        /// </value>
        [DataMember]
        public string CostIncreaseDecrease { get; set; }
