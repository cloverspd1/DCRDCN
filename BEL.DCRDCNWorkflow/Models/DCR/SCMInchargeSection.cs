namespace BEL.DCRDCNWorkflow.Models.DCR
{
    ...
    public class SCMInchargeSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SCMInchargeSection"/> class.
        /// </summary>
        public SCMInchargeSection()
        {
        }
        ...
        /// The SCM User.
        /// </value>
        [DataMember, IsPerson(true, true, false), Required, RequiredOnDelegate,IsViewer]
        ...
        /// The Marketing User.
        /// </value>
        [DataMember, IsPerson(true, true, true), FieldColumnName("SCMUser"),  IsViewer]
        ...
        public bool IsSubmitted
        {
            get
            {
                if (this.ApproversList.Any(p => p.Role == DCRRoles.SCM && string.IsNullOrEmpty(p.Approver)))
                {
                    return true;
                }
                return false;
