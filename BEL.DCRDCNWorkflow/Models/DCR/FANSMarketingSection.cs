namespace BEL.DCRDCNWorkflow.Models.DCR
{
    ...
    public class FANSMarketingSection : ISection
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketingSection"/> class.
        /// </summary>
        public FANSMarketingSection()
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="FANSMarketingSection"/> class.
        /// </summary>
        /// <param name="isSet">if set to <c>true</c> [is set].</param>
        public FANSMarketingSection(bool isSet)
        {
            if (isSet)
            {
                this.ListDetails = new List<ListItemDetail>() { new ListItemDetail(DCRDCNListNames.DCRLIST, true) };
                this.SectionName = DCRSectionName.FANSMARKETINGSECTION;
