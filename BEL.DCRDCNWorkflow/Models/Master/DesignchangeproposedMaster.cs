namespace BEL.DCRDCNWorkflow.Models.Master
{
    ...
    public class DesignchangeproposedMaster : IMaster
    {
        /// <summary>
        ...
        {
            get { return DCRDCNListNames.DESIGNCHANGEPROPOSEDMASTER; }
            set { }
        }
        ...
        {
            get { return typeof(DesignchangeproposedMasterListItem); }
            set { }
        }
    }
}