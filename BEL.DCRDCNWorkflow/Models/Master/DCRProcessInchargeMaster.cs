namespace BEL.DCRDCNWorkflow.Models.Master
{
    ...
    public class DCRProcessInchargeMaster : IMaster
    {
        /// <summary>
        ...
        {
            get { return DCRDCNListNames.DCRPROCESSINCHARGEMASTERLIST; }
            set { }
        }
        ...
        {
            get { return typeof(DCRProcessInchargeMasterListItem); }
            set { }
        }
    }
}